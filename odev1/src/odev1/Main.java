...
public class Main {
	...
	Course course1 = new Course(1, "C# + Angulara" , "Engin Demiroð", "Yazýlým Geliþtirici Yetiþtirme Kampý");
	Course course2 = new Course(2, "Java + React" , "Engin Demiroð", "Yazýlým Geliþtirici Yetiþtirme Kampý");
